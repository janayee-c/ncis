...
export const ABOUT = "Nautical Crime Investigation Services (NCIS) provides technological solutions for national security and maritime defense. At NCIS, we use Artificial Intelligence and tracking technologies for risk assessment and detection of crime occurrences at sea and on land. NCIS technologies are developed with ethical AI in design. The goal is to increase transparency, accountaibility, protection of human rights and due process in crime detection."
