...
const Before = ({curr}) => {
  ...
  const renderContent = () => {
    if (page === 0) {
      ...
      <p className="hereLink">Find out more about the Deloitte Trustworthy AI <u><a target="_blank" rel="noreferrer" href="https://www2.deloitte.com/us/en/pages/deloitte-analytics/solutions/ethics-of-ai-framework.html">here.</a></u></p>
      </>
      )
    } else if (page === 3) {
      return (
